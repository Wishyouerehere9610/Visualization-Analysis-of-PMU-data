var svg
var focus = 0
var st=[[1,,],[4,-2100,-1315],[3.5,-1800,-680],[2.5,-300,-420],[2.85,-970,-100],[3.25,-1350,-550],[3.20,-1125,-1350],[4,-1700,-1280],[2.80,-725,-605]]
var regions=[[],[],[],[],[],[],[],[]]
var lines=[[],[],[],[],[],[],[],[]]
var plot=[]
    ...
    function()
    {
        ...
        (
            function(values)
            {
                ...
                //     .data(values[3])
                //     .enter().append("line")
                //     .attr("x1",function(d){return projection([values[2][d.from-1].x,values[2][d.from-1].y])[0]})
                //     .attr("y1",function(d){return projection([values[2][d.from-1].x,values[2][d.from-1].y])[1]})
                //     .attr("x2",function(d){return projection([values[2][d.to-1].x,values[2][d.to-1].y])[0]})
                //     .attr("y2",function(d){return projection([values[2][d.to-1].x,values[2][d.to-1].y])[1]})
                //     .attr("stroke","blue")
                ...
                for(i=0;i<regions.length;i++)
                {
                    ...
                    //     for(i=0;i<values[3].length;i++)
                    //     {
                    //         if(values[3][i].from == d.id || values[3][i].to == d.id)
                    //         {
                    //             svg.append("line")
                    //             .attr("x1",function(d){return projection([values[2][values[3][i].from-1].x,values[2][values[3][i].from-1].y])[0]})
                    //             .attr("y1",function(d){return projection([values[2][values[3][i].from-1].x,values[2][values[3][i].from-1].y])[1]})
                    //             .attr("x2",function(d){return projection([values[2][values[3][i].to-1].x,values[2][values[3][i].to-1].y])[0]})
                    //             .attr("y2",function(d){return projection([values[2][values[3][i].to-1].x,values[2][values[3][i].to-1].y])[1]})
                    //             .attr("stroke","white")
                    //             .style('stroke-width',"0.5px")
                    //             .attr("class", "line")
                    //         }
